...
WHERE a.Title LIKE "Middle of Nowhere";
...
SELECT a.ArtistName, COUNT(s.SongId) AS 'Song Count'
FROM Artist a
...
SELECT r.ArtistName, a.Title AS 'Album Title', s.Title AS 'Song Title', MAX(s.SongLength) AS 'Song Length'
FROM Song s
LEFT JOIN Album a ON s.AlbumId = a.AlbumId
LEFT JOIN Artist r ON s.ArtistId = r.ArtistId;